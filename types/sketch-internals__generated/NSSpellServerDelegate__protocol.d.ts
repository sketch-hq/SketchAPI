interface INSSpellServerDelegate {
  ...
  spellServer_checkGrammarInString_language_details(sender: NSSpellServer, stringToCheck: NSString | string, language: NSString | string | null, details: MOPointer<NSArray<any>>): NSRange;
