...
declare const SUCodeSigningVerifier: {
  ...
  class(): SUCodeSigningVerifier;
  codeSignatureAtBundleURL_matchesSignatureAtBundleURL_error(oldBundlePath: NSURL, newBundlePath: NSURL, error: MOPointer<NSError>): boolean;
  codeSignatureIsValidAtBundleURL_error(bundlePath: NSURL, error: MOPointer<NSError>): boolean;
