...
declare const SUBinaryDeltaUnarchiver: {
  ...
  class(): SUBinaryDeltaUnarchiver;
  updateSpotlightImportersAtBundlePath(targetPath: NSString | string): void;
  canUnarchivePath(path: NSString | string): boolean;
  mustValidateBeforeExtraction(): boolean;
  load(): void;
