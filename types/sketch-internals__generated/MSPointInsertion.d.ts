...
declare const MSPointInsertion: {
  ...
  class(): MSPointInsertion;
  insertPointAtLocation_index_layer_options(location: NSPoint, index: NSUInteger, layer: MSShapePathLayer, options: MSPointInsertionOptions): MSCurvePoint;
