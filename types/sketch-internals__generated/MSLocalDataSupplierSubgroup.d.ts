...
declare const MSLocalDataSupplierSubgroup: {
  ...
  class(): MSLocalDataSupplierSubgroup;
  localDataSupplierSubgroupWithURL_localDataSupplierGroup(subgroupURL: NSURL, localDataSupplierGroup: MSLocalDataSupplierGroup): MSLocalDataSupplierSubgroup;
  load(): void;
