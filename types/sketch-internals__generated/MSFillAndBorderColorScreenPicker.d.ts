...
declare const MSFillAndBorderColorScreenPicker: {
  ...
  class(): MSFillAndBorderColorScreenPicker;
  pickColorForLayers_colorSpace_completionBlock(layers: NSArray<any> | any[], colorspace: NSColorSpace, completionBlock: BCVoidBlock): void;
