...
declare const MSImageSizeReducer: {
  ...
  class(): MSImageSizeReducer;
  reduceImageSizeOfLayers_windowForSheet_completionBlock(layers: NSArray<any> | any[], windowForSheet: NSWindow | null, completionBlock: BCVoidBlock | null): void;
