...
declare const MSFrequentColorsController: {
  ...
  class(): MSFrequentColorsController;  menuItemForColorCounter_target_action_documentColorSpace_colorModel(colorCounter: MSColorCounter, target: any, action: string, colorSpace: NSColorSpace, colorModel: MSComponentColorModel): NSMenuItem;
