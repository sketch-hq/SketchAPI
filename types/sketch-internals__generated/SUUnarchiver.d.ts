...
declare const SUUnarchiver: {
  ...
  class(): SUUnarchiver;
  unarchiverForPath_updatingHostBundlePath_decryptionPassword(path: NSString | string, hostPath: NSString | string | null, decryptionPassword: NSString | string | null): any;
  load(): void;
