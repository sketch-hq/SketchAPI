...
interface NSFormatter extends NSObject, INSCopying, INSCoding {
  ...
  isPartialStringValid_newEditingString_errorDescription(partialString: NSString | string, newString: MOPointer<NSString>, error: MOPointer<NSString>): boolean;
  isPartialStringValid_proposedSelectedRange_originalString_originalSelectedRange_errorDescription(partialStringPtr: MOPointer<NSString>, proposedSelRangePtr: NSRangePointer | null, origString: NSString | string, origSelRange: NSRange, error: MOPointer<NSString>): boolean;
