...
declare const MSFlowMenuBuilder: {
  ...
  class(): MSFlowMenuBuilder;
  createFlowDestinationMenuButton_document_destination_target(button: NSPopUpButton, doc: MSDocumentData, destinationID: NSString | string, target: any): void;
