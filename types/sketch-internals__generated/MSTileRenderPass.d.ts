...
declare const MSTileRenderPass: {
  ...
  class(): MSTileRenderPass;
  tileRenderPassWithPage_inDocument_dirtyRect_zoomValue(page: MSImmutablePage, documentData: MSImmutableDocumentData, dirtyRect: CGRect, zoomValue: CGFloat): MSTileRenderPass;
  load(): void;
