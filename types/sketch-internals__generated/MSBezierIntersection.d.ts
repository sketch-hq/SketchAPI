...
declare const MSBezierIntersection: {
  ...
  class(): MSBezierIntersection;
  intersectionWithSegment1_segment2_segment1Offset_segment2Offset(segment1: MSBezierSegment, segment2: MSBezierSegment, segment1Offset: CGFloat, segment2Offset: CGFloat): MSBezierIntersection;
  load(): void;
