...
declare const MSFlashViewController: {
  ...
  class(): MSFlashViewController;  flashViewControllerWithMessage_closeBlock_helpBlock(message: NSString | string, closeBlock: MSFlashViewControllerBlock | null, helpBlock: MSFlashViewControllerBlock | null): MSFlashViewController;
