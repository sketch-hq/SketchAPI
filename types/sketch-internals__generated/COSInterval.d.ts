...
declare const COSInterval: {
  ...
  class(): COSInterval;
  scheduleWithInterval_cocoaScript_jsFunction_repeat(i: NSTimeInterval, cos: COScript, jsFunction: MOJavaScriptObject | Function, repeat: boolean): any;
  createWithCocoaScript(cos: COScript): any;
