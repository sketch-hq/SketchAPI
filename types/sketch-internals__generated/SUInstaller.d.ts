...
declare const SUInstaller: {
  ...
  class(): SUInstaller;
  installerForHost_fileOperationToolPath_updateDirectory_error(host: SUHost, fileOperationToolPath: NSString | string, updateDirectory: NSString | string, error: MOPointer<NSError>): any;
