...
declare const MSSymbolPreviewGenerator: {
  ...
  class(): MSSymbolPreviewGenerator;
  imageForSymbolAncestry_withSize_colorSpace_trimmed(ancestry: MSImmutableLayerAncestry, size: NSSize, colorSpace: NSColorSpace, trimmed: boolean): NSImage;
  load(): void;
