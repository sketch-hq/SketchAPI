...
declare const MSAttributeConverter: {
  ...
  class(): MSAttributeConverter;
  converterWithAttributeName_block(attributeName: NSString | string, conversionBlock: MSAttributeConverterBlock): MSAttributeConverter;
  load(): void;
