...
interface NSMutableAttributedString extends NSAttributedString {
  ...
  readFromURL_options_documentAttributes_error(url: NSURL, opts: NSDictionary<any, any> | {[key: string]: any}, dict: MOPointer<NSDictionary<any, any>>, error: MOPointer<NSError>): boolean;
  readFromData_options_documentAttributes_error(data: NSData, opts: NSDictionary<any, any> | {[key: string]: any}, dict: MOPointer<NSDictionary<any, any>>, error: MOPointer<NSError>): boolean;
  ...
  readFromURL_options_documentAttributes(url: NSURL, options: NSDictionary<any, any> | {[key: string]: any}, dict: MOPointer<NSDictionary<any, any>>): boolean;
  readFromData_options_documentAttributes(data: NSData, options: NSDictionary<any, any> | {[key: string]: any}, dict: MOPointer<NSDictionary<any, any>>): boolean;
