...
declare const MSJSONDictionaryUnarchiver: {
  ...
  class(): MSJSONDictionaryUnarchiver;
  unarchiveObjectFromDictionary_asVersion_corruptionDetected_error(dict: NSDictionary<any, any> | {[key: string]: any}, version: MSDocumentVersion, corruption: boolean | null, error: MOPointer<NSError>): any;
}
